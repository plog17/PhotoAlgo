...
%fullres
%code=strcat('<div class="col-md-6 portfolio-item"><a href=""pictures/q1_aligned_',filename,'"><img class="img-responsive" src="pictures/q2_aligned_',filename,'" alt=""></a><h4><a href="pictures/q2_aligned_>',filename,'"</a></h4><p>Décalage du canal rouge : x=',rxoffset,', y=',ryoffset,'<br>Décalage du canal vert : x=', gxoffset,', y=',gyoffset,'</p></div>');
